...
import sys
import os
path = os.path.dirname(os.getcwd()) + '/test_nodes'
...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        refMsg = generate_LineSegment(center_line_interp[:,:2], id=1,colors=[1.0, 1.0, 0.0], namespace='Center_Line', scale=[0.05, 0.05, 0.05])
